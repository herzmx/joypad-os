...
// NEOGEO controller to DC gamepad adapter
//
// This app reads native NEOGEO controllers and outputs DC gamepad.
// Supports NEOGEO controllers/sticks 4/6 buttons.

#ifndef APP_NEOGEO2DC_H
#define APP_NEOGEO2DC_H

// ============================================================================
// APP METADATA
// ============================================================================
#define APP_NAME "NEOGEO2DC"
#define APP_VERSION "1.0.0"
#define APP_DESCRIPTION "NEOGEO controller to DC gamepad adapter"
...
// These can be customized for different boards
    ...
    // Dreamcast Maple Bus pins (must be consecutive)
    #define DC_MAPLE_PIN1  5  // Data line A
    #define DC_MAPLE_PIN5  6  // Data line B (PIN1 + 1)
#else
    ...
    // Dreamcast Maple Bus pins (must be consecutive)
    #define DC_MAPLE_PIN1  28   // Data line A
    #define DC_MAPLE_PIN5  29   // Data line B (PIN1 + 1)
#endif
...
// ============================================================================
// Routing mode: Simple 1:1 (single NEOGEO -> single DC port)
