...
// Default KB2040
    ...
    #define P1_NEOGEO_DU_PIN 3
    #define P1_NEOGEO_DD_PIN 29
    #define P1_NEOGEO_DR_PIN 28
    #define P1_NEOGEO_DL_PIN 4
    #define P1_NEOGEO_S1_PIN 15
    #define P1_NEOGEO_S2_PIN 7
    #define P1_NEOGEO_B1_PIN 5
    #define P1_NEOGEO_B2_PIN 27
    #define P1_NEOGEO_B3_PIN 6
    #define P1_NEOGEO_B4_PIN 26
    #define P1_NEOGEO_B5_PIN 8
    #define P1_NEOGEO_B6_PIN 14
#else
