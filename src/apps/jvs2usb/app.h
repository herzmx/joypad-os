...
//
// This app reads native JVS controllers and outputs USB HID gamepad.
// Supports JVS controllers/sticks 4/6 buttons.
...
#define JVS_MAX_CONTROLLERS 2          // 2 controller from 1 JVS

// Output drivers
#define REQUIRE_USB_DEVICE 1
#define USB_OUTPUT_PORTS   2           // Single USB gamepad output
...
#define MAX_PLAYER_SLOTS 2                   // Single player for now
