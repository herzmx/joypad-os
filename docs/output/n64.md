...
|-------------|-------------|--------|-------|
| Data GPIO (e.g., GPIO 7) | Pin 2 | Joybus data | Bidirectional, needs pull-up |
| 3.3V detect GPIO (e.g., GPIO 6) | Pin 3 | 3.3V from console | Input with pull-down; if LOW at boot, reboots to bootloader |
| GND | Pin 1 or 6 | Ground | Common ground |

Power the adapter from the console's 3.3V (pin 3 → 3V3 input) or via USB.
